...
class TestMethods(unittest.TestCase):
    def test_by_country(self):
        ...
        self.assertEqual(
            ...
            dico('Algeria'))
        self.assertNotEqual(
            {"country": "Al", "year": 7, "value": 1.3}, dico('Algeria'))
        self.assertTrue(
            {"country": "Algeria", "year": 2017, "value": 130493.653},
            dico('Algeria'))
        self.assertIsNot(
    ...
    def test_average_for_year(self):
        ...
        self.assertNotEqual(
            {"year": 2017, "total": 219666.44571830984}, avg(2016))
        ...
        self.assertEqual(type(
            {
                ...
                2015: 4.5,
                2016: 4.515,
                2017: 4.565}), type(per_capi('France')))
